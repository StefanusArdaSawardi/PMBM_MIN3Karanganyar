...
@section('styles')
  <link rel="stylesheet" href="{{ asset('assets/landing/program-fullday/vars.css') }}">
  <link rel="stylesheet" href="{{ asset('assets/landing/program-fullday/style.css') }}">
@endsection

@section('content')
  <div class="pmbm-program-fullday">
    ...
    <div class="fokus-pada-pengembangan-karakter-holistik-melalui-kegiatan-ekstrakurikuler-seni-olahraga-dan-kepemimpinan">
      Fokus pada pengembangan karakter holistik melalui kegiatan ekstrakurikuler seni, olahraga, dan kepemimpinan.
    </div>
    <div class="program-fullday">Program Fullday</div>
    ...
    <img
      ...
      src="{{ asset('assets/landing/program-fullday/save-clip-app-475343519-1307796727230381-3144782383292744901-n-10.png') }}"
      alt="Program Fullday Ilustrasi"
    />
    ...
    <div style="position: absolute; left: 665px; top: 891px; width: 450px; display: flex; flex-direction: column; gap: 12px; z-index: 10;">
      ...
      <div style="display: flex; align-items: flex-start; gap: 13px;">
        <img src="{{ asset('assets/landing/program-fullday/check-fill0.svg') }}" alt="Icon" style="width: 30px; height: 30px; flex-shrink: 0;" />
      ...
      <!-- Item 2 -->
      <div style="display: flex; align-items: flex-start; gap: 13px;">
        <img src="{{ asset('assets/landing/program-fullday/check-fill1.svg') }}" alt="Icon" style="width: 30px; height: 30px; flex-shrink: 0;" />
        <div style="color: #3f4940; text-align: left; font-family: 'Roboto-Regular', sans-serif; font-size: 15px; line-height: 24px; letter-spacing: -0.4px; font-weight: 400; padding-top: 3px;">
      ...
      <!-- Item 3 -->
      <div style="display: flex; align-items: flex-start; gap: 13px;">
        <img src="{{ asset('assets/landing/program-fullday/check-fill2.svg') }}" alt="Icon" style="width: 30px; height: 30px; flex-shrink: 0;" />
        <div style="color: #3f4940; text-align: left; font-family: 'Roboto-Regular', sans-serif; font-size: 15px; line-height: 24px; letter-spacing: -0.4px; font-weight: 400; padding-top: 3px;">
