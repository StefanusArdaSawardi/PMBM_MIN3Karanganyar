...
@section('content')
  <div class="desktop-19" style="padding-bottom: 500px !important;">
    ...
    <form action="{{ route('tata_usaha.accounts.store') }}" method="POST">
      @csrf

      <div class="heading-2">
        <div class="data-identitas-pengguna">Data Identitas Pengguna</div>
      </div>
      
      <div class="container">
        <div class="lengkapi-informasi-di-bawah-ini-untuk-mendaftarkan-akun-staf-atau-panitia-baru-ke-dalam-sistem-pmbm">
          Lengkapi informasi di bawah ini untuk mendaftarkan akun staf atau panitia baru ke dalam sistem PMBM.
        </div>
      </div>
