...
@section('title', 'Tambah Pengguna Baru - Admin Portal')
...
@section('content')
  <div class="desktop-19" style="padding-bottom: 120px !important;">
    ...
    <div style="position: absolute; left: 380px; top: 140px; right: 40px; max-width: 1050px; display: flex; flex-direction: column; gap: 20px; z-index: 10;">
      ...
      <form action="{{ route('tata_usaha.accounts.store') }}" method="POST" style="display: flex; gap: 24px; width: 100%; align-items: flex-start; flex-wrap: wrap;">
        @csrf

        <!-- LEFT COLUMN: Form Inputs -->
        <div style="flex: 1.3; min-width: 340px; display: flex; flex-direction: column; gap: 16px;">
          <div style="display: flex; flex-direction: column; gap: 4px;">
            <div style="font-size: 22px; font-weight: bold; color: #064e3b; font-family: 'PlusJakartaSans-Bold', sans-serif;">Data Identitas Pengguna</div>
            <div style="font-size: 13px; color: #6b7280;">Lengkapi informasi di bawah ini untuk mendaftarkan akun staf atau panitia baru ke dalam sistem PMBM.</div>
          </div>
          ...
          <div class="grid-layout-for-desktop">
            ...
            <div class="full-name">
              ...
              <div class="container2">
                <div class="input">
                  <input type="text" name="name" id="name-input" value="{{ old('name') }}" placeholder="Masukkan nama lengkap" required autocomplete="off">
            ...
            <div class="email">
              ...
              <div class="container2">
                <div class="input">
                  <input type="email" name="email" id="email-input" value="{{ old('email') }}" placeholder="contoh@min3.sch.id" required autocomplete="off">
            ...
            <div class="username">
              ...
              <div class="container2">
                <div class="input">
                  <input type="text" id="username-input" placeholder="username_unik" value="{{ old('username') }}" autocomplete="off">
            ...
            <div class="confirm-password">
              <div class="label">
                <div class="konfirmasi-password">Konfirmasi Password</div>
              </div>
              <div class="container2">
                <div class="input">
                  <input type="password" name="password_confirmation" id="confirm-password-input" placeholder="••••••••" required>
...
@section('scripts')
  <script>
    ...
    // Run sync on load if values exist (e.g. from validation error redirects)
